...
impliziert, dass die Abbildung $\vec{x} \mapsto A \cdot \vec{x}$ injektiv ist, w\"ahrend
...
\\[0.2cm]
und bezeichnen wir die Umkehr-Abbildung mit $f^{-1}$, so k\"onnen wir sehen, dass $f^{-1}$ ebenfalls
