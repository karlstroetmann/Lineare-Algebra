...
\solution
Wir zeigen, dass die Funktionen $f_k$ für alle $k \in \{1, \cdots, p-1\}$ injektiv sind.  Da die
Menge $\mathbb{Z}_p$ endlich ist, sind die Funktionen $f_k$ dann nach Satz \ref{satz:injektiv_folgt_surjektiv} 
auch surjektiv und damit bijektiv.  Um die Injektivität der Funktion $f_k$ zu zeigen, nehmen wir
an, dass
\\[0.2cm]
\hspace*{1.3cm}
...
hergeleitet und folglich die Injektivität von $f_k$ nachgewiesen.  \qeds
...
\solution
Wir zeigen zunächst, dass alle Nebenklassen von $G$ die selbe Anzahl von Elementen haben.  Dazu
