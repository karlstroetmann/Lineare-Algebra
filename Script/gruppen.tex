...
definieren wir für alle $k \in \{1,\cdots,p-1\}$ eine Funktion
\\[0.2cm]
\hspace*{1.3cm}
$f_k: \mathbb{Z}_p \rightarrow \mathbb{Z}_p$ \quad durch \quad $f_k(n) = (k \cdot n) \;\texttt{\symbol{37}}\;p$.
\\[0.2cm]
Zeigen Sie, dass die Funktionen $f_k$ für alle $k \in \{1, \cdots, p-1\}$ bijektiv sind.

\hint
Sie dürfen die folgenden beiden Fakten aus der elementaren Zahlentheorie ohne Beweis verwenden:
\begin{enumerate}
...
ist, während die Richtung von rechts nach links daraus folgt, dass $R$ rechts-total ist.
...
\begin{Definition}[Faktor-Gruppe]
  ...
  Dann definieren wir f\"{u}r jedes $a \in G$ die Menge $a{\color{dg}{+}}U$ als
  \\[0.2cm]
  \hspace*{1.3cm}
  $a {\color{dg}{+}} U := \{ a + x \mid x \in U \}$.
  \\[0.2cm]
  Wir bezeichnen die Mengen $a {\color{dg}{+}} U$ als \emph{\colorbox{gold}{Nebenklassen} von $G$ bez\"{u}glich $U$}.
  Nun definieren wir die Menge $G/U$ (gelesen: $G$ modulo $U$) als
  \\[0.2cm]
  \hspace*{1.3cm}
  $G/U := \bigl\{ a {\color{dg}{+}} U \mid a \in G \bigr\}$.
  \\[0.2cm]
  ...
  \\[0.2cm]
  \hspace*{1.3cm}
  $(a {\color{dg}{+}} U) {\color{red}{+}} (b {\color{dg}{+}} U) := (a + b) {\color{dg}{+}} U$.
\end{Definition}
...
\\[0.2cm]
\hspace*{1.3cm}
$a_1 {\color{dg}{+}} U = a_2 {\color{dg}{+}} U \;\wedge\; b_1 {\color{dg}{+}} U = b_2 {\color{dg}{+}} U \;\Rightarrow\; (a_1 + b_1) {\color{dg}{+}} U = (a_2 + b_2) {\color{dg}{+}} U$
\\[0.2cm]
...
Aufschluss gibt, wann zwei Nebenklassen $a {\color{dg}{+}} U$ und $b {\color{dg}{+}} U$ gleich sind.
\eox
...
\begin{Lemma}
  ...
  \\[0.2cm]
  \hspace*{1.3cm}
  $a {\color{dg}{+}} U = b {\color{dg}{+}} U$ \quad g.d.w. \quad $a - b \in U$.
\end{Lemma}
...
\begin{enumerate}
\item[``$\Rightarrow$'']:
  Gelte $a {\color{dg}{+}} U = b {\color{dg}{+}} U$.  Wegen $0 \in U$ haben wir
  \\[0.2cm]
  \hspace*{1.3cm}
  $a = a + 0 \in a {\color{dg}{+}} U$
  \\[0.2cm]
  und wegen der Voraussetzung $a {\color{dg}{+}} U = b {\color{dg}{+}} U$ folgt daraus
  \\[0.2cm]
  \hspace*{1.3cm}
  $a \in b {\color{dg}{+}} U$.
  \\[0.2cm]
...
\item[``$\Leftarrow$'']: Gelte nun $a - b \in U$.  Weil $U$ eine Untergruppe ist und Untergruppen zu jedem
  ...
  \\[0.2cm]
  \hspace*{1.3cm} 
  $a {\color{dg}{+}} U \subseteq b {\color{dg}{+}} U$ \quad als auch \quad
  $b {\color{dg}{+}} U \subseteq a {\color{dg}{+}} U$ 
  \\[0.2cm]
  gilt.
  \begin{enumerate}
  \item Sei $x \in a {\color{dg}{+}} U$.  Dann gibt es ein $u \in U$, so dass
        \\[0.2cm]
        \hspace*{1.3cm}
        $x = a + u$
        \\[0.2cm]
        ...
        $x = b + v$ mit $v \in U$
        \\[0.2cm]
        und nach Definition von $b {\color{dg}{+}} U$ folgt dann $x \in b {\color{dg}{+}} U$.
  \item Sei nun $x \in b {\color{dg}{+}} U$.  Dann gibt es ein $u \in U$, so dass
        \\[0.2cm]
        \hspace*{1.3cm}
        $x = b + u$
        \\[0.2cm]
        ...
        $x = a + v$ mit $v \in U$
        \\[0.2cm]
        und nach Definition von $a {\color{dg}{+}} U$ folgt nun $x \in a {\color{dg}{+}} U$. \qed
  \end{enumerate}
\end{enumerate}
...
$a_1 {\color{dg}{+}} U = a_2 {\color{dg}{+}} U \;\wedge\; b_1 {\color{dg}{+}} U = b_2 {\color{dg}{+}} U \;\Rightarrow\; (a_1 + b_1) {\color{dg}{+}} U = (a_2 + b_2) {\color{dg}{+}} U$
\\[0.2cm]
gilt.  Sei also $a_1 {\color{dg}{+}} U = a_2 {\color{dg}{+}} U$ und $b_1 {\color{dg}{+}} U = b_2 {\color{dg}{+}} U$ vorausgesetzt.  
Zu zeigen ist dann
\\[0.2cm]
\hspace*{1.3cm}
$(a_1 + b_1) {\color{dg}{+}} U = (a_2 + b_2) {\color{dg}{+}} U$.
\\[0.2cm]
Aus $a_1 {\color{dg}{+}} U = a_2 {\color{dg}{+}} U$ folgt nach dem letzten Lemma $a_1 - a_2 \in U$  und aus
$b_1 {\color{dg}{+}} U = b_2 {\color{dg}{+}} U$ folgt $b_1 - b_2 \in U$.  Da $U$ unter der Operation $+$ abgeschlossen ist, folgt
\\[0.2cm]
\hspace*{1.3cm}
...
\begin{Satz}
 Es sei $\langle G, 0, + \rangle$ eine kommutative Gruppe und $U \leq G$.
 Dann ist $\langle G/U, 0 {\color{dg}{+}} U, {\color{red}{+}} \rangle$ mit der oben definierten Addition von Nebenklassen eine kommutative Gruppe.
\end{Satz}

\proof
Der Beweis zerf\"{a}llt in drei Teile.
\begin{enumerate}
\item $0 {\color{dg}{+}} U$ ist das links-neutrale Element, denn wir haben
      \\[0.2cm]
      \hspace*{1.3cm}
      $(0 {\color{dg}{+}} U) {\color{red}{+}} (a {\color{dg}{+}} U) = (0 + a) {\color{dg}{+}} U = a {\color{dg}{+}} U$ \quad f\"{u}r alle $a \in G$.
\item $-a {\color{dg}{+}} U$ ist das links-inverse Element zu $a {\color{dg}{+}} U$, denn wir haben
      \\[0.2cm]
      \hspace*{1.3cm}
      $(-a {\color{dg}{+}} U) {\color{red}{+}} (a {\color{dg}{+}} U) = (-a + a) {\color{dg}{+}} U = 0 {\color{dg}{+}} U$ \quad f\"{u}r alle $a \in G$.
\item Es gilt das Assoziativ-Gesetz, denn
      \\[0.2cm]
      \hspace*{1.3cm}
      $
      \begin{array}[t]{cl}
        & \bigl((a {\color{dg}{+}} U) {\color{red}{+}} (b {\color{dg}{+}} U)\bigr) {\color{red}{+}} (c {\color{dg}{+}} U)   \\
      = & \bigl((a + b) {\color{dg}{+}} U\bigr) {\color{red}{+}} (c {\color{dg}{+}} U)         \\
      = & \bigl((a + b) + c\bigr) {\color{dg}{+}} U               \\
      = & \bigl(a + (b + c)\bigr) {\color{dg}{+}} U               \\
      = & (a {\color{dg}{+}} U) {\color{red}{+}} \bigl((b + c) {\color{dg}{+}} U\bigr)         \\
      = & (a {\color{dg}{+}} U) {\color{red}{+}} \bigl((b {\color{dg}{+}} U) {\color{red}{+}} (c {\color{dg}{+}} U)\bigr).  \\
      \end{array}
      $
\item Es gilt das Kommutativ-Gesetz, denn
      ...
      $
      \begin{array}[t]{cll}
        & (a {\color{dg}{+}} U) {\color{red}{+}} (b {\color{dg}{+}} U) \\
      = & (a + b) {\color{dg}{+}} U       \\
      = & (b + a) {\color{dg}{+}} U & \mbox{denn $G$ ist eine kommutative Gruppe} \\
      = & (b {\color{dg}{+}} U) {\color{red}{+}} (a {\color{dg}{+}} U). & \hspace*{\fill} \Box
      \end{array}
      $
\end{enumerate}
...
\\[0.2cm]
\hspace*{1.3cm}
$\mathbb{Z}_k := \mathbb{Z}/(k\mathbb{Z}) = \bigl\{ l {\color{dg}{+}} k\mathbb{Z} \mid l \in \mathbb{Z} \}$
\\[0.2cm]
zusammen mit der durch
\\[0.2cm]
\hspace*{1.3cm}
$(l_1 {\color{dg}{+}} k\mathbb{Z}) {\color{red}{+}} (l_2 {\color{dg}{+}} k\mathbb{Z}) = (l_1 + l_2) {\color{dg}{+}} k\mathbb{Z}$
\\[0.2cm]
definierten Addition eine Gruppe ist, deren neutrales Element die Menge $0 {\color{dg}{+}} k\mathbb{Z} = k\mathbb{Z}$ ist.
Es gilt
\\[0.2cm]
\hspace*{1.3cm}
$l_1 {\color{dg}{+}} k\mathbb{Z} = l_2 {\color{dg}{+}} k\mathbb{Z}$
\\[0.2cm]
genau dann, wenn
\\[0.2cm]
\hspace*{1.3cm}
...
\\[0.2cm]
\hspace*{1.3cm}
$\mathbb{Z}_k = \bigl\{ l {\color{dg}{+}} k\mathbb{Z} \mid l \in \{0, \cdots, k - 1\} \bigr\}$.
\vspace*{0.2cm}
