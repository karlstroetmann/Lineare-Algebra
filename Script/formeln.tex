...
zur Verfügung stehen.  Die Mengenlehre ist der Gegenstand des folgenden Kapitels.
...
\item Das Prädikat $\textsl{isPrime}(n)$ soll für eine natürliche Zahl $n \in \mathbb{N}$ genau dann
      ...
      Divison von $a$ durch $b$ übrig bleibt.  Beispielsweise gilt $13 \;\texttt{\%}\; 5 = 3$, denn
      $12 = 2 \cdot 5 + 3$.
