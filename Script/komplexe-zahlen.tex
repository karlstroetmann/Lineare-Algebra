...
\example Wir berechnen alle Lösungen der Gleichung $r^3 = 1 + i$.  Dazu müssen wir zunächst die Zahl $1 +
...
(\ref{eq:komplex_potenz}) angegeben ist. \exend
...
\\[0.2cm]
\hspace*{1.3cm}
\framebox{\colorbox{amber}{$e^{i \cdot \varphi} = \cos(\varphi) + i \cdot \sin(\varphi)$.}}
\\[0.2cm]
...
\\[0.2cm]
\hspace*{1.3cm}
\framebox{\colorbox{amber}{$e^{i \cdot \pi} = -1$.}}
\\[0.2cm]
