...
\remark
Sind $V_1$, $V_2$ und $V_3$ Vektor-Räume und gilt
\\[0.2cm]
\hspace*{1.3cm}
...
$l$-ten Zeile und schließlich multipliziert die Zeilen-Multiplikations-Matrix $\mathrm{ZM}_n(k, \alpha)$  die $k$-te Zeile
mit $\alpha$.  
...
$
\\[0.2cm]
zu berechnen.  Dazu wird zunächst die Variable $\mathtt{e}$ mit der Einheits-Matrix $E_3$
