...
\proof
Wir haben die beiden Eigenschaften von Untervektor-R\"{a}umen nachzuweisen. 
\begin{enumerate}
...
$
\\[0.2cm]
Definieren wir also die Komponenten der Matrix $C = (c_{i,j})_{1\leq i \leq n, 1 \leq j \leq l}$ als
\\[0.2cm]
\hspace*{1.3cm}
