...
Damit sind wir in der Lage, f\"{u}r alle $n \in \mathbb{N}$ eine \emph{Einheits-Matrix} $\mathrm{E}_n$ zu
...
\item Die $n \times n$ \emph{Zeilen-Multiplikations-Matrix} $\mathrm{ZM}_n(k, \alpha)$ wird f\"{u}r $\alpha \not= 0$ durch die Gleichung
      \\[0.2cm]
      \hspace*{1.3cm}
