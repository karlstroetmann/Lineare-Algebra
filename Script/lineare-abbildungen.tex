...
\begin{Definition}[Elementar-Matrizen]
  ...
  \begin{enumerate}
  \item Für $k\not=l$ wird die $n \times n$ \emph{Zeilen-Additions-Matrix} $\mathrm{ZA}_n(k,l,\alpha)$ durch
        \\[0.2cm]
        \hspace*{1.3cm}
        ...
        \right).
        $       
\item Die $n \times n$ \emph{Zeilen-Permutations-Matrix} $\mathrm{ZP}_n(k,l)$ wird durch die Gleichung 
      \\[0.2cm]
      \hspace*{1.3cm}
...
\item Die $n \times n$ \emph{Zeilen-Multiplikations-Matrix} $\mathrm{ZM}_n(k, \alpha)$ wird für $\alpha \not= 0$ durch die Gleichung
      \\[0.2cm]
      \hspace*{1.3cm}
