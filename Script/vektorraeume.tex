...
Falls bei einer Menge $V$ aus dem Zusammenhang klar ist, was das neutrale Element ``$\vec{0}$'' ist und
wie die Operatoren ``$+$'' und ``$\cdot$'' zu  definieren sind, so dass
 $\bigl\langle \langle V, \vec{0}, + \rangle, \cdot \bigr\rangle$ ein $\mathbb{K}$-Vektor-Raum wird, dann sprechen wir in Zukunft von
$V$ als $\mathbb{K}$-Vektor-Raum und meinen damit, dass das Tripel $\bigl\langle \langle V, \vec{0}, +
...
Es sei $\mathcal{V} = \bigl\langle \langle V, \vec{0}, + \rangle, \cdot \bigr\rangle$ ein Vektor-Raum.  
...
\begin{Lemma}[Austausch-Lemma]
  Es sei $\mathcal{V} = \bigl\langle \langle V, \vec{0}, + \rangle, \cdot \bigr\rangle$
  ein Vektor-Raum, $B$ eine Basis von $\mathcal{V}$, $U \subseteq B$, $\vec{x} \in V\backslash B$ und die
...
\item Als erstes zeigen wir, dass  $(B \backslash \{ \vec{y} \}) \cup \{ \vec{x} \}$ ein Erzeugenden-System von $\mathcal{V}$ ist.
      ...
      ist, lässt sich $\vec{z}$ als Linear-Kombination von Vektoren aus $B$ darstellen.  Es gibt
...
Das gerade bewiesene Lemma zeigt uns, dass wir in einer Basis einen beliebigen von dem Nullvektor verschiedenen Vektor $\vec{x}$
...
\begin{Satz}[Basis-Austausch-Satz]
  Es sei $\mathcal{V} = \bigl\langle \langle V, \vec{0}, + \rangle, \cdot \bigr\rangle$ ein $\mathbb{K}$-Vektor-Raum 
  und $B$ sei eine Basis von $V$.  Weiter sei $U \subseteq V$ linear unabhängig.
...
\item[I.S.:] $n \mapsto n+1$. 
             ...
             \\[0.2cm]
             eine Basis von $\mathcal{V}$ ist.  Wir definieren nun
             \\[0.2cm]
             \hspace*{1.3cm}
