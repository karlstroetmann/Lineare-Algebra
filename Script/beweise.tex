...
\proof
Wir nehmen an, dass $p$ ungerade ist.  Damit lässt sich $p$  in der Form
\\[0.2cm]
\hspace*{1.3cm}
...
rationale Zahl lässt sich in der Form $\bruch{p}{q}$ mit $p,q \in \mathbb{Q}$ schreiben.  Dabei können
