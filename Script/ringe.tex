...
\begin{center}
\hspace*{-0.3cm}
\framebox{\framebox{\colorbox{red}{In dieser Vorlesung werden wir nur solche Ringe betrachten, die kommutativ sind und eine Eins haben.}}}
\end{center}
...
\"{A}quivalenz-Relation auf $R$.   Wir nennen $\sim$ eine \colorbox{yellow}{\emph{Kongruenz-Relation}} falls zus\"{a}tzlich
