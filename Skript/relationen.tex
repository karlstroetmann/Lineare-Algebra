...
\item Wir haben $x \el [x]_R$ genau dann, wenn 
      ...
      Die Eigenschaft $x \mathop{R} x$ folgt aber unmittelbar aus der Reflexivit\"{a}t von $R$. {\color{green}{$\surd$}}
