...
In der Theorie der \blue{relationalen} Datenbanken werden Relationen üblicherweise in Form von Tabellen
...
definieren wir
\[ N^M := \{ R \subseteq M \times N \mid \mbox{$R$ ist funktionale Relation}\, \}. \]
...
so ist das \colorbox{yellow}{\blue{relationale Produkt}} $R \circ Q$ wie folgt definiert: \\[0.2cm]
\hspace*{1.3cm}
...
Das relationale Produkt von $Q$ und $R$ wird gelegentlich auch als die \colorbox{yellow}{\blue{Komposition}} von
...
\begin{Definition}[Identische Relation]
  Ist $M$ eine Menge, so definieren wir die \colorbox{yellow}{\blue{identische Relation}} $\mathrm{id}_M \subseteq M \times M$
  wie folgt: \\[0.2cm]
...
\blue{Symmetrie} ist:  Zwar kann eine symmetrische Relation nicht asymmetrisch sein, aber es gibt
...
\blue{Asymmetrie} zwei verschiedene Begriffe sind.
\eox
