...
$\left(\frac{x}{2}\right)^2 = \frac{x^2}{4}$ auf 
beiden Seiten: 
\\[0.2cm]
\hspace*{1.3cm}
...
\\[0.2cm]
\hspace*{1.3cm}
$a = \sqrt{\frac{1}{2} \cdot \Bigl(x + \sqrt{x^2 + y^2\,}\Bigr)\;}$ \quad oder \quad 
$a = -\sqrt{\frac{1}{2} \cdot \Bigl(x + \sqrt{x^2 + y^2\,}\Bigr)\;}$.
\\[0.2cm]
Setzen wir diesen Wert in Gleichung (\ref{eq:komplex_root2}) ein, so ergibt sich für $b$ der Wert
\\[0.2cm]
\hspace*{1.3cm}
$b = \frac{y}{\sqrt{2\cdot \Bigl(x + \sqrt{x^2 + y^2\,}\Bigr)\;}}$ \quad oder \quad 
$b = -\frac{y}{\sqrt{2\cdot \Bigl(x + \sqrt{x^2 + y^2\,}\Bigr)\;}}$.
\\[0.2cm]
Insgesamt erhalten wir damit für das Ergebnis 
\\[0.2cm]
\hspace*{1.3cm}
$a + i \cdot b = \sqrt{\frac{1}{2} \cdot \Bigl(x + \sqrt{x^2 + y^2\,}\Bigr)\;}
...
\item Wir suchen eine komplexe Zahl $a + i \cdot b$, so dass 
     ...
     $
       ...
       a + i \cdot b & = & \sqrt{0 + i \cdot 1\,} \\[0.2cm]
                     & = & \pm\sqrt{\frac{1}{2} \cdot \Bigl(0 + \sqrt{0 + 1\,}\Bigr)\;} \pm
                           i \cdot \frac{1}{\sqrt{2\cdot \Bigl(0 + \sqrt{0 + 1\,}\Bigr)\;}}    \\[0.2cm]
                     & = & \pm\sqrt{\frac{1}{2} \cdot 1\;} \pm i \cdot \frac{1}{\sqrt{2\cdot 1\;}} \\[0.4cm]
                     & = & \pm\frac{1}{\sqrt{2}} \cdot \bigl(1 + i\bigr).
       \end{array}
       $
\item Wir suchen eine komplexe Zahl $a + i \cdot b$, so dass
       \\[0.2cm]
       ...
       \begin{array}[t]{lcl}
             a + i \cdot b 
       & = & \pm \sqrt{\frac{1}{2} \cdot \Bigl(3 + \sqrt{9 + 16\,}\Bigr)\;} \pm
             i \cdot \frac{4}{\sqrt{2\cdot \Bigl(3 + \sqrt{9 + 16\,}\Bigr)\;}}    \\[0.2cm]
       & = & \pm\sqrt{\frac{1}{2} \cdot (3 + 5)\;} \pm i \cdot \frac{4}{\sqrt{2\cdot (3 + 5)\;}}     \\[0.2cm]
       & = & \pm\sqrt{\frac{1}{2} \cdot (8)\;} \pm i \cdot \frac{4}{\sqrt{2\cdot 8\;}}     \\[0.2cm]
       & = & \pm\sqrt{4\,} \pm i \cdot \frac{4}{\sqrt{16\,}}     \\[0.2cm]
       & = & \pm \left(2 + i \cdot \frac{4}{4}\right)     \\[0.2cm]
       & = & \pm(2 + i)
       \end{array}
       $
\end{enumerate}
...
wir auch festlegen, dass wir die Zahl  $a + i \cdot b$ meinen, f\"ur die der Imaginärteil
...
\\[0.2cm]
\hspace*{1.3cm} $\varphi = \arctan\Bigl(\frac{1}{1}\Bigr) = \arctan(1) = \frac{\pi}{4}$,
\\[0.2cm]
...
Ausdruck, nämlich $\frac{\pi}{4}$, angeben und zweitens konnten wir auch f\"ur die Anwendung der trigonometrischen
...
& = & \ds\left(\frac{q}{2} + \sqrt{\frac{q^2}{4} - \frac{p^3}{27}}\right) \cdot
      \left(\frac{q}{2} - \sqrt{\frac{q^2}{4} - \frac{p^3}{27}}\right)        \\[0.2cm]
& = & \ds\frac{q^2}{4} - \left(\frac{q^2}{4} - \frac{p^3}{27}\right)             \\[0.2cm]
& = & \ds\frac{p^3}{27}.                                            
\end{array}
$
\\[0.2cm]
...
x_2 & = & \zeta_3 \cdot u + \zeta_3^2 \cdot v                               \\[0.2cm]
    ...
    & = & \Bigl(- \frac{1}{2} + i \cdot \frac{\sqrt{3\,}}{2}\Bigr) \cdot (2 + i) + 
          \Bigl(- \frac{1}{2} - i \cdot \frac{\sqrt{3\,}}{2}\Bigr) \cdot (2 - i)   \\[0.3cm]
    & = & \frac{1}{2} \cdot \bigl(-2 - \sqrt{3} + i \cdot (-1 + 2 \cdot \sqrt{3}) 
...
wir später sehen, dass die Ausdr\"ucke $e^x$, $\sin(x)$ und $\cos(x)$ wie folgt 
...
Gleichung lösen und ganz allgemein hat jede Gleichung $n$-ten Grades f\"ur $n\in \mathbb{N}^*$
