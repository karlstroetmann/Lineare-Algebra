...
auch in den Vorlesungen \"uber theoretische Informatik verwenden werden.  Grob können wir
...
\begin{Satz} 
Es seien $u$ und $v$ natürliche Zahlen mit $u > v$.  Dann bilden die Zahlen
\\[0.2cm]
\hspace*{1.3cm}
...
\href{https://de.wikipedia.org/wiki/Eulersche_Zahl}{\blue{Eulersche Zahl}} ist, dann erhalten wir
\\[0.2cm]
\hspace*{1.3cm}
...
rekursiver Funktionen benötigt wird.  Es sei
...
\\[0.2cm]
Wir definieren eine \blue{Menge} $M$ als die Menge\footnote{
...
für $n$ die Zahl $n_0$ einsetzen, dann können wir dann folgern, dass
\\[0.2cm]
\hspace*{1.3cm}
$F\bigl((n_0-1) +1\bigr)$
\\[0.2cm] 
