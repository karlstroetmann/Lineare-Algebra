...
\proof
Zunächst folgt aus der Tatsache, dass einerseits $u$ und $v$ positive natürliche Zahlen sind und
...
für $n$ die Zahl $n_0 - 1$ einsetzen, dann können wir also folgern, dass
\\[0.2cm]
\hspace*{1.3cm}
$F\bigl((n_0-1) +1\bigr)$
\\[0.2cm] 
