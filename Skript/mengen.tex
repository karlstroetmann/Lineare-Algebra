...
\href{https://en.wikipedia.org/wiki/ISO_31-11}{\textsc{Iso}-Standard 31-11} so festgelegt.\footnote{
  ...
  aber die Bezeichnungen für die Menge $\mathbb{N}$ hat sich dabei nicht geändert.
}
...
\item Induktions-Schritt: $n \mapsto n + 1$.
      ...
      \\[0.2cm]
      Offenbar sind die Mengen $A$ und $B$ \emph{disjunkt}, dass heißt diese Mengen enthalten keine
...
\section{Differenz-Mengen}
 Sind zwei Mengen $M$ und $N$ gegeben, so bezeichen wir die 
...
\href{https://de.wikipedia.org/wiki/Extensionalitätsaxiom}{\emph{Extensionalit\"{a}ts-Axiom}}
f\"{u}r Mengen: 
\vspace*{0.2cm}
...
zum Beweis der 
\href{https://de.wikipedia.org/wiki/Großer_Fermatscher_Satz}{\emph{Fermat'schen Vermutung}}. Diese
