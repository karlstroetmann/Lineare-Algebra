...
Etwas verkÃ¼rzt kÃ¶nnen wir den Mengen-Begriff wie folgt definieren: 
\\[0.2cm]
\hspace*{1.3cm}
...
\\[0.2cm]
gezeigt.  Das ist aber logisch nicht mÃ¶glich, eine Formel kann nicht genau dann wahr sein,
...
Mengen von Zahlen: 
\begin{enumerate}
\item $\mathbb{N}^*$ ist die Menge der positiven natÃ¼rlichen Zahlen, es gilt also
      \\[0.2cm]
      \hspace*{1.3cm}
