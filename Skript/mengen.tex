...
zu der Menge $M$ gehört oder nicht.  In diesem Fall sagen wir, dass $x$ ein \emph{Element} der
...
präzisieren, führte Cantor das sogenannte \colorbox{yellow}{\emph{Komprehensions-Axiom}} ein.
...
\href{https://de.wikipedia.org/wiki/Aussonderungsaxiom}{\emph{Aussonderungs-Axiom}}
 ist eine Abschwächung des Komprehensions-Axiom.  Die Idee
...
eine Menge von dieser Art.  Wir können dann die Vereinigung aller Mengen, die Elemente
...
einführen zu können, müssen wir zunächst \emph{Teilmengen} definieren.  Sind $M$ und
$N$ zwei Mengen, so heißt $M$ eine \emph{Teilmenge} von $N$ genau dann, wenn jedes Element der
...
\item Induktions-Schritt: $n \mapsto n + 1$.
      ...
      \\[0.2cm]
      Offenbar sind die Mengen $A$ und $B$ \emph{disjunkt}, das heißt diese Mengen enthalten keine
...
\href{https://en.wikipedia.org/wiki/Axiom_of_extensionality}{\emph{Extensionalitäts-Axiom}}
für Mengen: 
\vspace*{0.2cm}
...
\href{https://en.wikipedia.org/wiki/Countable_set}{\emph{abzählbar}}, wenn eine 
...
\href{https://en.wikipedia.org/wiki/Uncountable_set}{\emph{überabzählbar}}, wenn sie
