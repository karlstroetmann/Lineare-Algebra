...
unendliche Mengen von Vektoren gelten.  Das führt aber zu einer etwas umständlicheren Theorie.
\eox
...
\item Wir zeigen, dass $\{ \vec{y}_1, \cdots \vec{y}_{n-1}, \vec{x} \}$ linear unabhängig ist.
      ...
      \\[0.2cm]
      so dass wir insgesamt die Gleichung (\ref{eq:atl4}) gezeigt haben.  Damit ist die lineare Unabhängigkeit
