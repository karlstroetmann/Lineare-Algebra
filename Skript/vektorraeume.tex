...
\begin{Definition}[Basis]
  ...
  {\emph{\color{blue}Basis}} von $V$, wenn das Folgende gilt:
  \begin{enumerate}
...
Ist diese Anzahl endlich und hat den Wert $n$, so bezeichnen wir sie als die \emph{\color{blue}Dimension} des Vektor-Raums $\mathcal{V}$ und definieren
\\[0.2cm]
\hspace*{1.3cm}
