...
\item Es gibt eine Vielzahl von mathematischen Methoden, die unmittelbar in der Informatik
      ...
      \item \href{https://en.wikipedia.org/wiki/Recurrence_relation}{\emph{Rekurrenz-Gleichungen}}
            ...
            von \href{https://de.wikipedia.org/wiki/AVL-Baum}{AVL-Bäumen}\footnote{
...
\begin{enumerate}
\item Das Buch ``\blue{Set Theory and Related Topics}'' von Seymour Lipschutz \cite{lipschutz:1998} enthält den
      Stoff, der in diesem Skript in dem Kapitel über \blue{Mengenlehre} abgehandelt wird.  Eine ältere Version
...
\item Das Buch ``\blue{Linear Algebra}'' von Seymour Lipschutz und Marc Lipson \cite{lipschutz:2012}
      enthält den Stoff zur eigentlichen \blue{linearen Algebra}.  Auch hier ist eine ältere Version 
