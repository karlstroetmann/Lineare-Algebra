...
Die erste Methode funktioniert in sogenannten \emph{\color{blue}Integrit\"{a}ts-Ringen}, dass sind
solche Ringe, in denen sich das neutrale Element der Addition, also die $0$, nicht als Produkt
zweier von $0$ verschiedenener Elemente darstellen l\"{a}sst.  Dann l\"{a}sst sich n\"{a}mlich aus
