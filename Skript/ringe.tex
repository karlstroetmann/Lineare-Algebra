...
\end{enumerate}
Die Struktur $\mathcal{R}$ ist ein {\color{blue}\emph{kommutativer Ring}} falls zusätzlich für die Multiplikation
...
$\langle \mathbb{Q}, 0, 1, +, \cdot \rangle$ vor.  In einem solchen Fall sprechen wir von einem {\color{blue}\emph{Körper}}.  Die formale
Definition folgt.


\begin{Definition}[Körper]
Ein $5$-Tupel $\mathcal{K} = \langle K, 0, 1, +, \cdot \rangle$ ist ein {\color{blue}\emph{Körper}}, falls gilt:
\begin{enumerate}
...
\begin{Definition}[Integritäts-Ring]
  Ein Ring $\mathcal{R} = \langle R, 0, 1, +, \cdot \rangle$ heißt {\color{blue}\emph{nullteilerfrei}}, wenn
  \\[0.2cm]
  \hspace*{1.3cm}
  ...
  Ein nullteilerfreier, kommutativer Ring wird als {\color{blue}\emph{Integritäts-Ring}}
  bezeichnet.
\eoxs
\end{Definition}
...
Äquivalenz-Relation auf $R$.   Wir nennen $\sim$ eine {\color{blue}\emph{Kongruenz-Relation}} auf $\mathcal{R}$ 
...
\\[0.2cm]
der {\color{blue}\emph{formalen Brüche}}.  Die Idee dabei ist, dass wir das Paar
...
\begin{Definition}[maximales Ideal]
  ...
  $I$ von $\mathcal{R}$ mit $I \not= R$ ist ein {\color{blue}\emph{maximales Ideal}} genau dann, wenn für jedes andere Ideal
