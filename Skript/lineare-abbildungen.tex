...
m\"ussten, die aber bei Flie{\ss}komma-Rechnung statt dessen einen sehr kleinen Wert wie etwa 
$2 \cdot 10^{-16}$ annehmen.  W\"are nun $A_{j,i}$ bei exakter Rechnung $0$ und w\"urde durch einen
Rundungs-Fehler statt dessen ein sehr kleiner Wert \"ubrig bleiben, so w\"urden wir in der folgenden Rechnung
