...
als Listen dargestellt.  Beachten Sie, dass der Ausdruck $M \,\texttt{**}\, 2$ für eine Menge $M$
...
\exercise 
Zeigen Sie, dass die Funktion $\mathtt{det}$ bezüglich jeder Zeile der Matrix \emph{\color{blue}additiv} ist: Zeigen Sie
...
\exercise 
Zeigen Sie, dass die Funktion $\mathtt{det}$ bezüglich jeder Zeile der Matrix \emph{\color{blue}homogen} ist: Zeigen Sie
also, dass in dem Fall, dass die Matrix $A$ die Form
\\[0.2cm]
\hspace*{1.3cm}
$\mathtt{det}\left(
