...
Für den mathematisch Geübten ist diese Formel offensichtlich leichter zu verstehen als
...
\item \blue{Funktions-Zeichen}
      ...
      ist durch das Zeichen ``$\mathtt{\sin}$'' gegeben, das in der Mathematik für die
...
\item \blue{Prädikate}
      ...
      ist das Gleichheits-Prädikat, das durch das Gleichheits-Zeichen ``$=$'' dargestellt
      ...
      Zum Beispiel könnten wir ein Prädikat ``\texttt{istQuadrat}'' definieren, das für natürliche
...
\item \blue{Junktoren} 
      ...
      Junktoren werden dazu benutzt, Formeln miteinander in Beziehung zu setzen.  Der einfachste Junktor
